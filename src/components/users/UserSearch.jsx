    ...
    <div
      ...
      {users.length > 0 ? (
        <>
          <div
            className={
              'col-span-2 md:col-span-3 lg:col-span-3 xl:col-span-3'
            }>
              ...
              <div className='form-control'>
                <div className='relative'>
                  <input
                    type='text'
                    className={
                      'input input-lg w-full pr-30 text-black bg-gray-200 rounded-xl'
                    }
                    value={text}
          ...
          <div className={'col-span-1'}>
            <button
              className='btn btn-ghost btn-lg min-w-full'
        ...
        <div
          className={
            'col-span-3 md:col-span-4 lg:col-span-4 xl:col-span-4'
          }>
          <form onSubmit={handleSubmit}>
            <div className='form-control'>
              <div className='relative'>
                <input
                  type='text'
                  className={
                    'input input-lg w-full text-black bg-gray-200 rounded-xl'
                  }
                  value={text}
                  onChange={handleChange}
                  placeholder={'Search'}
